...
from users.views import UserActive, UserDeactive, UsersList, accountSettings, load_printers, EngineerCommentsOnJobcardForm, AllJobCardsEngineer, jobcard_pending_on_engineer, EngineerCommentsOnJobcard, jobcard_assigned_engineer, jobcard_pending_ccn_head, user_submitted_jobcard, update_profile, profile, jobcard_view, JobForarded, jobcard_approved, jobcard_rejected, job_card_on_user_head, add_jobcard_problem, jobcard_problem_list, jobcard_problem_deactive, jobcard_problem_edit, jobcard_problem_active, UserLogin, add_jobcard, CcnJobCardList, jobcard_deactive, jobcard_active, home, Dashboard, UserLogOut, MyCustomer, add_division, division_list, division_edit, division_active, division_deactive
...
urlpatterns = [
    ...
    path('register/', update_profile.as_view(), name='register'),    
