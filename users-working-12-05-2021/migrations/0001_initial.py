# Generated by Django 3.2.1 on 2021-05-11 17:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_on', models.CharField(blank=True, choices=[('User Head', 'User Head'), ('CCN Head', 'CCN Head'), ('Engineer', 'Engineer'), ('Cutomer', 'Cutomer')], default='user_head', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('division_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.division')),
